              ...
              flexibleSpace: LayoutBuilder(
                builder: (BuildContext context, BoxConstraints constraints) {
                  ...
                  return FlexibleSpaceBar(
                    centerTitle: true,
                    titlePadding: EdgeInsets.only(bottom: 16.0 + (expandRatio * 56)),
                    title: Column(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final rawClass =
                      ...
                      StudentRowParser.classLabel(student);
                  final classDisplay =
                      rawClass.toLowerCase().startsWith('class') ||
                          rawClass.toLowerCase().startsWith('grade') ||
                          rawClass == '—'
                      ? rawClass
                      : 'Class $rawClass';
                  ...
                  final type =
                      student['institute_type']?.toString() ?? 'School';
